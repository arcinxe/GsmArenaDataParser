...
namespace ArktiPhones {
    public class ValuesExtractor {
        private ArktiPhones.Data inputDevice { get; set; }
        public DeviceDetails resultDevice { get; set; }
        public ValuesExtractor (ArktiPhones.Data device) {
            inputDevice = device;
        ...
        private void SetCameraVideoModes () {
            ...
            if (inputDevice.Detail.MainCamera?.Video != null) {
        ...
        private void SetOs () {
            ...
            resultDevice.OperatingSystem.LatestVersion = osLatestVersion;
